...
const MdxLink = (props: { href?: string; openNewTab?: boolean; className?: string; icon?: string; children?: ReactNode; style?: ENUM_ELEMENTS_LINK_STYLE; variant?: ENUM_ELEMENTS_LINK_VARIANT; direction?: ENUM_ELEMENTS_LINK_DIRECTION; relationship?: string; }) => {
  return (
    <Link
